...
class NewGroupViewController: KeyboardBasedLayoutViewController {
    ...
    override func viewDidLoad() {
        ...
        participentLabel.text = R.string.localizable.group_title_members(members.count + 1)
        loadGroupIcon()
    ...
    class func instance(members: [GroupUser]) -> UIViewController {
        ...
        vc.members = members
        return ContainerViewController.instance(viewController: vc, title: R.string.localizable.group_navigation_title_new_group())
    }
