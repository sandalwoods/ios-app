...
class BlockedUsersViewController: UIViewController {
        ...
        DispatchQueue.global().async { [weak self] in
            ...
            DispatchQueue.main.async {
                ...
                weakSelf.tableView.checkEmpty(dataCount: users.count,
                                              text: R.string.localizable.setting_blocked_empty(),
    ...
    class func instance() -> UIViewController {
        ...
        let container = ContainerViewController.instance(viewController: vc, title: R.string.localizable.setting_blocked())
        return container
    }
