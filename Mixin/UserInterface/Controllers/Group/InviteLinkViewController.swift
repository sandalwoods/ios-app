...
class InviteLinkViewController: UIViewController {
    ...
    class func instance(conversation: ConversationItem) -> UIViewController {
        ...
        return ContainerViewController.instance(viewController: vc, title: R.string.localizable.group_navigation_title_invite_link())
    }
...
extension InviteLinkViewController: ContainerViewControllerDelegate {
    ...
    func barRightButtonTappedAction() {
        ...
        alc.addAction(UIAlertAction(title: R.string.localizable.group_button_title_reset_link(), style: .default, handler: { [weak self] (_) in
            self?.revokeLink()
        }))
