...
class AllTransactionsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        dataSource.onReload = { [weak self] in
            ...
            weakSelf.tableView.checkEmpty(dataCount: weakSelf.dataSource.snapshots.count,
                                          text: R.string.localizable.wallet_no_transaction(),
    ...
    class func instance() -> UIViewController {
        ...
        let container = ContainerViewController.instance(viewController: vc, title: R.string.localizable.wallet_all_transactions_title())
        return container
    }
